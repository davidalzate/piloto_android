...
public class NEMobilMain extends Activity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_refresh: 
                ...
                accountManager.getAuthToken(account, "ah", false, new GetAuthTokenCallback(this), null);
                */
 ...
 /*   private class GetAuthTokenCallback implements AccountManagerCallback<Bundle> {
    	private NEMobilMain neMobilMain;
		public GetAuthTokenCallback(NEMobilMain neMobilMain) {
    		this.neMobilMain = neMobilMain;
        ...
        protected void onGetAuthToken(Bundle bundle) {
            ...
            new GetCookieTask(neMobilMain).execute(auth_token);
    }
};*/
    	 ...
    	 private class GetCookie extends AsyncTask<String, Void, Boolean> {
    	  ...
    	  protected Boolean doInBackground(String... tokens) {
    	   ...
    	   try {
    	    ...
    	    HttpGet httpGet = new HttpGet("http://nuevaeramedellin.appspot.com/_ah/login?continue=http://localhost/&auth=" + tokens[0]);
    	  ...
    	  protected void onPostExecute(Boolean result) {
    	   ...
    	   new MyAuthenticatedRequest().execute("http://nuevaeramedellin.appspot.com/nuevaera/identityresource");
    	  }
    	 }
